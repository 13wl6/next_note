...
export default defineConfig({
  ...
  themeConfig: {
      ...
      { text: '首页', link: '/' },
      {
        ...
        items: [
          ...
          },
          {
            ...
            text: '网站搭建',
            items: [
              { text: '什么是域名', link: '/website/domain' },
              { text: '域名解析', link: '/website/domain_dns' },
              { text: '服务器', link: '/website/server' },
              { text: '网站搭建', link: '/website/setup' },
            ],
          },
          {
            text: '前端',
            items: [
              { text: 'Vue', link: '/frontend/vue/start' },
              { text: 'React', link: '/frontend/react/start' },
            ],
          },
          {
            text: '后端',
            items: [
              { text: 'Node', link: '/rearend/node/start' },
              { text: 'Nest', link: '/rearend/nest/start' },
              { text: 'PHP', link: '/rearend/php/start' },
            ],
          },
        ],
      },
      { text: '网站搭建', link: '/website/domain' },
      { text: '前端', link: '/frontend/vue/start' },
      { text: '后端', link: '/rearend/node/start' },
    ],
    ...
    //     collapsed: false,
    //     items: [
    //       { text: 'Vue', items: [{ text: 'vue3', link: '/frontend/vue' }] },
    ...
    //     collapsed: false,
    //     items: [
    //       { text: 'Node', link: '/rearend/node' },
    //       { text: 'Nest', link: '/rearend/nest' },
    //       { text: 'PHP', link: '/rearend/php' },
    //     ],
    //   },
    // ],
      ...
      '/frontend/vue': [
        {
          ...
          collapsed: false,
          items: [
            { text: '快速上手', link: '/frontend/vue/start' },
          ],
        }
      ],
      '/frontend/react': [
        {
          ...
          collapsed: false,
          items: [
            { text: '快速上手', link: '/frontend/react/start' },
          ],
        }
      ],
      '/rearend/node/': [
        {
          ...
          collapsed: false,
          items: [
            { text: '快速上手', link: '/rearend/node/start' },
          ],
        }
      ]
    },
